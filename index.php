    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if ($title == 'Home') {
              ...
              echo "Détails Des Activités";
             } elseif ($title == 'Edit Project') {
              echo "Modifier Les Activités";
             } elseif ($title = 'Edit Land') {
                echo "Modifier Parcelles/Bassins";
             }
              else {
              echo "Page Inconnue";
             }
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id='submit'
                                onclick="$('#uni_modal form').submit()">Soumettre</button>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <?= date("Y"); ?> <a href="https://www.vitagro.sn/"
                    style="text-decoration: none;">Vitagro</a>.</strong>
            Tout Droit Réservé.
