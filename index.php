...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top"><img id="the-logo" src="img/vitagro.png" alt=""></a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#services" class="page-scroll dropbtn">Services</a>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>Bienvenue sur <span>Vitagro</span></h2>
          <hr>
    ...
    <div class="row">
      <div class="col-md-3 text-center">
        ...
        <div class="service-desc">
          <h3>Conseils en Agro-business</h3>
      ...
      <div class="col-md-3 text-center">
        ...
        <div class="service-desc">
          <h3>Formation en Agro-business</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
        </div>
      </div>
      <div class="col-md-3 text-center">
        ...
        <div class="service-desc">
          <h3>Organisation de Foires agricoles</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
        </div>
      </div>
      <div class="col-md-3 text-center">
        ...
        <div class="service-desc">
          <h3>Aménagement des Parcelles</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="categories">
      <ul class="cat">
        <li>
          <ol class="type">
            <li><a href="#" data-filter="*" class="active">Tous les produits</a></li>
            <li><a href="#" data-filter=".lawn">Arachides</a></li>
            <li><a href="#" data-filter=".garden">Patate Douce</a></li>
            <li><a href="#" data-filter=".planting">Piment Vert</a></li>
            <li><a href="#" data-filter=".planting">Elevage de Poisson</a></li>
          </ol>
        </li>
      </ul>
