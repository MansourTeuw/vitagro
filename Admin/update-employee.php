                      ...
                      <div class="row">
                        <div class="col-md-7">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="col-sm-6">
                            <img src="uploads/<?php echo $row['user_image'];?>" style="width:200px; border-radius:50%; margin:10px;">
                              <input type="file" name="user_image_update" class="form-control input-custom" required>
                              <input type="hidden" name="user_image" class="form-control" value="<?php echo $row['user_image'];?>">
                            </div>
                          </div>
