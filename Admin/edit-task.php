                        ...
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    <label class="control-label col-sm-5">Titre</label>
			                    <div class="col-sm-7">
                              ...
                              <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <?php 
			                        ...
			                        $info = $obj_admin->manage_all_info($sql);   
			                      ?>
			                      <select class="form-control" name="selected_land" id="selected_land" <?php if($user_role != 1){ ?> disabled="true" <?php } ?>>
			                        <option value="">Selectionner Parcelles...</option>

			                        <?php while($rows = $info->fetch(PDO::FETCH_ASSOC)){ ?>
			                        <option value="<?php echo $rows['land_id']; ?>" <?php
			                        	if($rows['user_id'] == $row['t_land_id']){
			                         ?> selected <?php } ?>><?php echo $rows['land_name']; ?></option>
			                        <?php } ?>
			                      </select>
			                    </div>
