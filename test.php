...
<header id="header">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/products/arachide.jpg" class="d-block w-100" alt="Arachide">
      <div class="carousel-caption d-none d-md-block">
        <h5>Culture d'Arachide</h5>
        <p>Some representative placeholder content for the first slide.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/products/patate-douce.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Patate Douce</h5>
    ...
    <div class="carousel-item">
      <img src="img/products/pument-vert.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Pument Vert</h5>
    ...
    <div class="carousel-item">
      <img src="img/products/pisciculture.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Pisciculture</h5>
        <p>Some representative placeholder content for the third slide.</p>
      </div>
