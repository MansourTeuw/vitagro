...
(function (global, factory) {
  ...
  // the Suspendu selection in the history, and pushes the old Suspendu
  ...
  // of a bidi jump deSuspendu on the visual position of the head.
  ...
  TextareaInput.prototype.reset = function (typing) {
    if (this.contextMenuSuspendu || this.composing) {
      return;
    }
    var cm = this.cm;
    if (cm.somethingSelected()) {
  ...
  TextareaInput.prototype.onContextMenu = function (e) {
    var input = this,
      ...
      display = cm.display,
      te = input.textarea;
    if (input.contextMenuSuspendu) {
      input.contextMenuSuspendu();
    }
    var pos = posFromMouse(cm, e),
    ...
    input.contextMenuSuspendu = rehide;
    ...
    function rehide() {
      if (input.contextMenuSuspendu != rehide) {
        return;
      }
      input.contextMenuSuspendu = false;
