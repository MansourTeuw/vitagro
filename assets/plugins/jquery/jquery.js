...
(function (global, factory) {
  ...
  jQuery.Callbacks = function (options) {
    ...
    var // Flag to know if list is currently firing
      ...
      fire = function () {
        ...
        // Execute callbacks for all Suspendu executions,
      ...
      self = {
        ...
        // Abort any current/Suspendu executions
  ...
  jQuery.extend({
    ...
    ready: function (wait) {
      // Abort if there are Suspendu holds or we're already ready
  ...
  jQuery.extend({
    ...
    ajax: function (url, options) {
      ...
      // Set the Accepts header for the server, deSuspendu on the dataType
      jqXHR.setRequestHeader(
        'Accept',
