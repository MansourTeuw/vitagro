  ...
  function (window, document, undefined, framework) {
    ...
    var PLUGIN = (function () {
      ...
      function OverlayScrollbarsInstance(
        ...
        function setupResponsiveEventListener(
          ...
          var passive =
            ...
            (passiveOrOptionsIsObj
              ? passiveOrOptions._passive || false
              : passiveOrOptions);
          var capture =
         ...
         * if "sync" then the async update process (MutationObserver or UpdateLoop) gets synchronized and a corresponding update takes place if one was needed due to Suspendu changes.
         * if "zoom" then a update takes place where it's assumed that content and host size changed
         * @returns {boolean|undefined}
         * If force is "sync" then a boolean is returned which indicates whether a update was needed due to Suspendu changes.
