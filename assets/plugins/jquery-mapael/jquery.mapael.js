...
(function (factory) {
  ...
  Mapael.prototype = {
    ...
    onUpdateEvent: function (e, opt) {
      ...
      // This function remove an element using animation (or not, deSuspendu on animDuration)
    ...
    drawLink: function (id, xa, ya, xb, yb, elemOptions) {
      ...
      // There are two solutions, we choose one or the other deSuspendu on the sign of the factor
