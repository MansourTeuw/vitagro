...
(function (factory) {
  ...
  function _fnLanguageCompat(lang) {
    ...
    if (lang) {
      ...
      if (
        !lang.sEmptyTable &&
        zeroRecords &&
        defaults.sEmptyTable === 'Pas de données disponibles pour cette table'
      ) {
    ...
    var cellProcess = function (cell) {
      if (colIdx === undefined || colIdx === i) {
        ...
        if (col && col._bAttrSrc) {
          ...
          // DeSuspendu on the `data` option for the columns the data can
  ...
  function _fnSortListener(settings, colIdx, append, callback) {
    ...
    // If apSuspendu the sort then we are multi-column sorting
   ...
   * return an array of objects or arrays deSuspendu upon your table's
  ...
  DataTable.defaults = {
     ...
     *
     * The `ajax` property has three different modes of operation, deSuspendu on
    ...
    oLanguage: {
       ...
       *  @type string
       *  @default Pas de données disponibles pour cette table
       *
       *  @dtopt Language
       ...
       *      $('#example').dataTable( {
       *        "language": {
       *          "emptyTable": "Pas de données disponibles pour cette table"
       *        }
       *      } );
       *    } );
       */
      sEmptyTable: 'Pas de données disponibles pour cette table',
