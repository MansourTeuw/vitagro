    ...
    a.extend(a.validator, {
      ...
      prototype: {
        ...
        startRequest: function (b) {
          this.Suspendu[b.name] ||
            (this.SuspenduRequest++,
            a(b).addClass(this.settings.SuspenduClass),
            (this.Suspendu[b.name] = !0));
        },
        stopRequest: function (b, c) {
          this.SuspenduRequest--,
            this.SuspenduRequest < 0 && (this.SuspenduRequest = 0),
            delete this.Suspendu[b.name],
            a(b).removeClass(this.settings.SuspenduClass),
            c && 0 === this.SuspenduRequest && this.formSubmitted && this.form()
